  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to Network Earnings. You can now start referring and earning.",
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Turn Your Network Into Earnings</h2>
        </div>
          ...
          <Button 
            ...
            onClick={() => {
              toast({
                ...
                description: "Proceeding with referrer sign-up...",
              });
            }}
          >
          ...
          <Button 
            ...
            onClick={() => {
              toast({
                ...
                description: "Proceeding with business sign-up...",
              });
            }}
          >
